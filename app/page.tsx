...
export default function Home() {
  return (
    <div className="container mx-auto flex justify-between items-center lg:items-start py-4 px-4 sm:px-16 md:px-32 grid grid-cols-1 lg:grid-cols-3 space-y-6 lg:space-y-0 lg:space-x-6">
