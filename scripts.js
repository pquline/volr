                ...
                <div class="row align-items-center">
                    <div class="col-auto d-flex align-items-center">
                        <span class="badge text-bg-${
                          entry.state
                        } stateBadge" data-bs-toggle="tooltip" data-bs-title="${
      entry.state === "danger" ? "Immobile" : "Mobile"
    }">
                            ${
                              entry.state === "warning"
                    ...
                    <div class="col text-truncate px-0">
                        <h6 class="mb-0 text-truncate" data-bs-toggle="tooltip" data-bs-title="${
                          entry.station
                        }">${entry.station}</h6>
                    </div>
      ...
      entry.line
                    ...
                    <div class="row align-items-center">
                        ...
                        <div class="col-auto text-end">
                            <div class="badge numberBadge" data-bs-toggle="tooltip" data-bs-title="Nombre de contributions">${
                              entry.edits
                            }</div>
                        </div>
                    </div>
